...
@Component({
  ...
  styles: [`
    ...
    .info-grid { display:grid; grid-template-columns:1fr 1fr;
      gap:10px; background:#f8fafc; border-radius:10px;
    ...
    label { display:block; font-size:12px; color:#475569;
      margin:14px 0 5px; }
    select { width:100%; padding:10px 14px; border:1px solid #e2e8f0;
...
export class AssignOfficerComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.adminService.getOfficers().subscribe(o => this.officers = o);
  }
